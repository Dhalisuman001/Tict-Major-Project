          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sensor Entry</h3>
              </div>
             <form action="sensor" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sensor_name" name="sensor_name" placeholder="Enter Sensor Name"  required>
                  </div>
                  <div class="form-group">
                    <label for="SensorType">Sensor Type</label>
                    <input type="text" class="form-control" id="sensor_type" name="sensor_type" placeholder="Enter Sensor Type" required>
                  </div>
